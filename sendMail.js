      ...
      html: `
          <div style="background-color: #080B0E; padding: 20px; border-radius: 15px; font-family: 'Poppins', sans-serif; height: '250px';">
                <div style="text-align: center;">
                    <img src='https://res.cloudinary.com/dedvy9tuv/image/upload/v1709089154/codecomponents/ab4w0thyztalfm2vguo3.png' alt="Logo" style="width: 125px; border-radius: 50%; margin: 0 auto;" />
                </div>
                <h1 style="color: #fff; font-size: 28px; text-align: center; margin-top: 10px; margin-bottom: 5px; letter-spacing: 1px;">CodeComponents</h1>
                ...
                <p style="color: #fff; text-align: center; padding: 10px;">Welcome to codecomponents, where delightful culinary experiences await you! We're thrilled to have you as a part of our community.</p>
          </div>
            `,
    };
